...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || $amount < 1) {
        header('Location: ../../../donatieactie.php?msg=Vul alle velden correct in (minimaal €1)&type=error');
        exit;
    }
    ...
    try {
        $payment = $mollie->payments->create([
            ...
            "description" => "Ramadan donatie-actie 2025- $name | $email",
        ...
        header('Location: ../../../donatieactie.php?msg=Er is een fout opgetreden bij het verwerken van de betaling&type=error');
        exit;
    }
}